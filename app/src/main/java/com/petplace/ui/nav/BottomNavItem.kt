...
//            BottomNavItem("Hospedagens", Icons.Default.Home, Route.Hostings)
        data object BookingButton  :
            BottomNavItem("Reservas", Icons.Default.Book, Route.Booking)

        data object HostingsButton :
            BottomNavItem("Hospedagens", Icons.Default.Home, Route.Hostings)

        data object BookingButtonHost :
            BottomNavItem("Reservas", Icons.Default.Book, Route.BookingHost)
